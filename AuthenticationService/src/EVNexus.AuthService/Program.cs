...
.AddJwtBearer(options =>
{
    ...
    options.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        ValidIssuer = string.IsNullOrWhiteSpace(jwtSettings.Issuer)
            ? "EVNexus.AuthService"
            : jwtSettings.Issuer,

        ValidateAudience = true,

        ValidAudience = string.IsNullOrWhiteSpace(jwtSettings.Audience)
            ? "EVNexus.Microservices"
...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Version = "v1",
        Description =
            "Microservice managing authentication, JWT token issuing, " +
            "multi-tenant company onboarding, and protected profiles."
    });
...
// ============================================================
// Account Management & Status Services
// ============================================================
...
// Swagger is enabled for Azure deployment as well as local development.
app.UseSwagger();
